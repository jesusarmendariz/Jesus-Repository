...
public class TestCase8_Test {
	...
	public void test() throws InterruptedException {
         ...
         Thread.sleep(2000);
         assertTrue(adoptonePuppy.ispuppy4NameLitterDisplayed());
         assertTrue(adoptonePuppy.ispuppy4BreedLitterDisplayed());
         assertTrue(adoptonePuppy.ispuppy4adoptamountLitterDisplayed());
